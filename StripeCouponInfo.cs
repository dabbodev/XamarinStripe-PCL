...
namespace Xamarin.Payments.Stripe {
    public class StripeCouponInfo : IUrlEncoderInfo {
        ...
        {
            sb.AppendFormat ("percent_off={0}&duration={1}&", PercentOff, System.Net.WebUtility.UrlEncode (Duration.ToString ().ToLower ()));
            if (!string.IsNullOrEmpty (ID))
                sb.AppendFormat ("id={0}&", System.Net.WebUtility.UrlEncode (ID));
