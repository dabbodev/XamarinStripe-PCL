    ...
    public class StripePlanInfo : IUrlEncoderInfo {
        ...
        public virtual void UrlEncode (StringBuilder sb)
        {
            sb.AppendFormat ("id={0}&amount={1}&currency={2}&interval={3}&name={4}&",
                System.Net.WebUtility.UrlEncode (ID), Amount, System.Net.WebUtility.UrlEncode (Currency ?? "usd"), System.Net.WebUtility.UrlEncode (Interval.ToString().ToLower ()), System.Net.WebUtility.UrlEncode (Name));
