...
namespace Xamarin.Payments.Stripe {
    public class StripeCustomerInfo : IUrlEncoderInfo {
        ...
        {
            if (Card != null)
                sb.AppendFormat ("source={0}&", System.Net.WebUtility.UrlEncode (Card));
            if (Coupon != null)
                sb.AppendFormat ("coupon={0}&", System.Net.WebUtility.UrlEncode (Coupon));
            if (Email != null)
                sb.AppendFormat ("email={0}&", System.Net.WebUtility.UrlEncode (Email));
            if (Description != null)
                sb.AppendFormat ("description={0}&", System.Net.WebUtility.UrlEncode (Description));
            if (Plan != null)
                sb.AppendFormat ("plan={0}&", System.Net.WebUtility.UrlEncode (Plan));
            ...
            if (DefaultCardId != null)
                sb.AppendFormat ("default_card={0}&", System.Net.WebUtility.UrlEncode (DefaultCardId));
        }
    }
}
