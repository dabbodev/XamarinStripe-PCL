...
namespace Xamarin.Payments.Stripe {
    public class StripePayment {
        ...
        public StripeCharge Charge (int amount_cents, string currency, StripeCreditCardInfo card, string description)
        {
            ...
            return Charge (amount_cents, currency, null, card.Number, description);
        }

        public StripeCharge Charge (int amount_cents, string currency, string customer, string card, string description)
        {
            if (amount_cents < 0)
            ...
            if (!String.IsNullOrEmpty (description)) {
                str.AppendFormat ("description={0}&", System.Net.WebUtility.UrlEncode (description));
            }

            if (customer != null) {
                str.AppendFormat ("customer={0}&", System.Net.WebUtility.UrlEncode (customer));
            }

            if (card != null) {
                str.AppendFormat ("source={0}&", System.Net.WebUtility.UrlEncode (card));
            }
        ...
        public StripeCharge GetCharge (string charge_id)
        {
            ...
            string ep = String.Format ("{0}/charges/{1}", api_endpoint, System.Net.WebUtility.UrlEncode (charge_id));
        ...
        public StripeCollection<StripeCharge> GetCharges (int offset = 0, int count = 10, string customer_id = null, StripeDateTimeInfo created = null)
        {
            ...
            if (!String.IsNullOrEmpty (customer_id))
                str.AppendFormat ("customer={0}&", System.Net.WebUtility.UrlEncode (customer_id));
        ...
        public StripeDispute UpdateDispute (string charge_id, string evidence)
        {
            ...
            string ep = String.Format ("{0}/charges/{1}/dispute", api_endpoint, System.Net.WebUtility.UrlEncode (charge_id));
            return DoRequest<StripeDispute> (ep, "POST", String.Format ("evidence={0}", System.Net.WebUtility.UrlEncode (evidence)));
        }
        ...
        public StripeCharge Refund (string charge_id)
        {
            ...
            string ep = String.Format ("{0}/charges/{1}/refund", api_endpoint, System.Net.WebUtility.UrlEncode (charge_id));
        ...
        public StripeCharge Refund (string charge_id, int amount)
        {
            ...
            string ep = String.Format ("{0}/charges/{1}/refund?amount={2}", api_endpoint, System.Net.WebUtility.UrlEncode (charge_id), amount);
            return DoRequest<StripeCharge> (ep, "POST", null);
        }
        #endregion
        #region Customer
        StripeCustomer CreateOrUpdateCustomer (string id, StripeCustomerInfo customer)
        {
            ...
            string ep = String.Format (format, api_endpoint, System.Net.WebUtility.UrlEncode (id));
        ...
        public StripeCustomer GetCustomer (string customer_id)
        {
            ...
            string ep = String.Format ("{0}/customers/{1}", api_endpoint, System.Net.WebUtility.UrlEncode (customer_id));
        ...
        {
            string ep = string.Format ("{0}/events/{1}", api_endpoint, System.Net.WebUtility.UrlEncode (eventId));
        ...
        public StripeCollection<StripeEvent> GetEvents (int offset = 0, int count = 10, string type = null, StripeDateTimeInfo created = null)
        {
           ...
           str.AppendFormat ("offset={0}&count={1}&", offset, count);
            ...
            if (!string.IsNullOrEmpty (type))
                str.AppendFormat ("type={0}&", System.Net.WebUtility.UrlEncode (type));
        ...
        public StripeCreditCardToken GetToken (string tokenId)
        {
            ...
            string ep = string.Format ("{0}/tokens/{1}", api_endpoint, System.Net.WebUtility.UrlEncode (tokenId));
        ...
        public StripePlan GetPlan (string planId)
        {
            ...
            string ep = string.Format ("{0}/plans/{1}", api_endpoint, System.Net.WebUtility.UrlEncode (planId));
        ...
        public StripeSubscription Subscribe (string customerId, StripeSubscriptionInfo subscription)
        {
            ...
            string ep = string.Format (subscription_path, api_endpoint, System.Net.WebUtility.UrlEncode (customerId));
        ...
        {
            string ep = string.Format (subscription_path + "?at_period_end={2}", api_endpoint, System.Net.WebUtility.UrlEncode (customerId), atPeriodEnd.ToString (CultureInfo.InvariantCulture).ToLowerInvariant ());
        ...
        public StripeCollection<StripeInvoiceItem> GetInvoiceItems (int offset = 0, int count = 10, string customerId = null, StripeDateTimeInfo created = null)
        {
            ...
            str.AppendFormat ("count={0}&", count);
            if (!string.IsNullOrEmpty (customerId))
                str.AppendFormat ("customer={0}&", System.Net.WebUtility.UrlEncode (customerId));
        ...
        public StripeCard CreateCard (string customer_id, StripeCreditCardInfo card)
        {
            ...
            StringBuilder str = UrlEncode (card);
            string ep = String.Format ("{0}/customers/{1}/cards", api_endpoint, System.Net.WebUtility.UrlEncode (customer_id));
        ...
        public StripeCard DeleteCard (string customer_id, string card_id)
        {
            ...
            string ep = string.Format ("{0}/customers/{1}/cards/{2}", api_endpoint, System.Net.WebUtility.UrlEncode (customer_id),
                                       System.Net.WebUtility.UrlEncode (card_id));
        ...
        public StripeCard UpdateCard (string customer_id, StripeUpdateCreditCardInfo card)
        {
            ...
            string ep = string.Format (format, api_endpoint, System.Net.WebUtility.UrlEncode (customer_id),
                                       System.Net.WebUtility.UrlEncode (card.ID));
            return DoRequest<StripeCard> (ep, "POST", str.ToString ());
        }
        #endregion
